...
public class DebuggingCommands {
    ...
    @Command(aliases = {"testplace"}, usage = "[player]", desc = "Имитировать размещение блока", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testinteract"}, usage = "[player]", desc = "Имитировать взаимодействие с блоком", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
    ...
    @Command(aliases = {"testdamage"}, usage = "[player]", desc = "Имитация повреждения объекта", min = 1, max = 1, flags = "ts")
    @CommandPermissions("worldguard.debug.event")
