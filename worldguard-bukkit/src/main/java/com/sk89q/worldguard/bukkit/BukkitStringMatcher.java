...
public class BukkitStringMatcher implements StringMatcher {
    ...
    public World matchWorld(Actor sender, String filter) throws CommandException {
        ...
        if (filter.charAt(0) == '#') {
            ...
            if (filter.equalsIgnoreCase("#main")) {
                ...
                throw new CommandException(message("matcher.world.normal-missing"));
                ...
                throw new CommandException(message("matcher.world.nether-missing"));
                ...
                throw new CommandException(message("matcher.world.end-missing"));
                ...
                if (parts.length == 1) {
                    throw new CommandException(message("matcher.world.player-argument"));
                }

                return matchPlayers(sender, parts[1]).iterator().next().getWorld();
            } else {
                throw new CommandException(message("matcher.world.identifier-invalid", filter));
            }
        }
        ...
        throw new CommandException(message("matcher.world.name-missing"));
    }
    ...
    public Iterable<? extends LocalPlayer> matchPlayers(Actor source, String filter) throws CommandException {
        if (Bukkit.getServer().getOnlinePlayers().isEmpty()) {
            throw new CommandException(message("matcher.player.none"));
        }
        ...
        if (filter.charAt(0) == '#') {
            ...
            if (filter.equalsIgnoreCase("#world")) {
                ...
                throw new CommandException(message("matcher.player.group-invalid", filter));
            }
        }
