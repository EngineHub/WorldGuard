...
public class GeneralCommands {
    ...
    public void god(CommandContext args, CommandSender sender) throws CommandException {
        ...
        for (Player player : targets) {
            ...
            if (player.equals(sender)) {
                player.sendMessage(lang.getText("god-mode-enabled"));

                // Keep track of this
                included = true;
            } else {
                player.sendMessage(lang.getText("god-enabled-by-vplayer",
                        "%PLAYER%", plugin.toName(sender)));
            }
        }
        ...
        if (!included && args.hasFlag('s')) {
            sender.sendMessage(lang.getText("players-now-have-god"));
        }
    }
    ...
    public void ungod(CommandContext args, CommandSender sender) throws CommandException {
        ...
        for (Player player : targets) {
            ...
            // Tell the user
            if (player.equals(sender)) {
                player.sendMessage(lang.getText("god-mode-disabled"));

                // Keep track of this
                included = true;
            } else {
                player.sendMessage(lang.getText("god-disabled-by-vplayer",
                        "%PLAYER%", plugin.toName(sender)));
        ...
        // user a message so s/he know that something is indeed working
        if (!included && args.hasFlag('s')) {
            sender.sendMessage(lang.getText("players-no-longer-god"));
        }
    }
    ...
    public void heal(CommandContext args, CommandSender sender) throws CommandException {
        ...
        for (Player player : targets) {
            ...
            // Tell the user
            if (player.equals(sender)) {
                player.sendMessage(lang.getText("healed"));

                // Keep track of this
                included = true;
            } else {
                player.sendMessage(lang.getText("healed-by-vplayer",
                        "%PLAYER%", plugin.toName(sender)));
        ...
        // user a message so s/he know that something is indeed working
        if (!included && args.hasFlag('s')) {
            sender.sendMessage(lang.getText("players-healed"));
        }
    }
    ...
    public void slay(CommandContext args, CommandSender sender) throws CommandException {
        ...
        for (Player player : targets) {
            ...
            // Tell the user
            if (player.equals(sender)) {
                player.sendMessage(lang.getText("slain"));

                // Keep track of this
                included = true;
            } else {
                player.sendMessage(lang.getText("slain-by-vplayer",
                        "%PLAYER%", plugin.toName(sender) + "."));
        ...
        // user a message so s/he know that something is indeed working
        if (!included && args.hasFlag('s')) {
            sender.sendMessage(lang.getText("players-slain"));
        }
    }
    ...
    public void locate(CommandContext args, CommandSender sender) throws CommandException {
        ...
        if (args.argsLength() == 0) {
            ...
            sender.sendMessage(lang.getText("compass-reset-to-spawn"));
        } else {
            Player target = plugin.matchSinglePlayer(sender, args.getString(0));
            player.setCompassTarget(target.getLocation());

            sender.sendMessage(lang.getText("compass-repointed"));
        }
    }
    ...
    public void stack(CommandContext args, CommandSender sender) throws CommandException {
        ...
        player.sendMessage(lang.getText("items-compacted-into-stacks"));
    }
}
