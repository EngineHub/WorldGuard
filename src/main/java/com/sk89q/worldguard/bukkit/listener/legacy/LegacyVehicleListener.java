...
public class LegacyVehicleListener implements Listener {
     ...
     * @param plugin
     */
    public LegacyVehicleListener(WorldGuardPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onVehicleMove(VehicleMoveEvent event) {
        ...
        if (wcfg.useRegions) {
            ...
            if (event.getFrom().getBlockX() != event.getTo().getBlockX()
                ...
                boolean result = LegacyPlayerListener.checkMove(plugin, player, event.getFrom(), event.getTo());
                if (result) {
